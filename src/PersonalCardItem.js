...
function PersonalCardItem() {
  ...
  return (
    <div className='card card-about'>
      <section className='card card-personal'>
        <aside className='card-text'>
          ...
          <p><span>¡Hola de nuevo!👋</span></p>
        </aside>
        <aside className='card-window'/>
        <aside className='card-text'>
          <p>
            Soy un apasionado de la tecnología, tecnico en programación de 
            software y estudiante de ingenieria de sistemas y computación, 
            con experiencia en el desarrollo de software y soporte técnico.  
            Mi pasión, además de la tecnología, son los videojuegos, la 
    ...
    <p>
          ...
          Además, tengo conocimientos en métodos y técnicas de pruebas y calidad de software
