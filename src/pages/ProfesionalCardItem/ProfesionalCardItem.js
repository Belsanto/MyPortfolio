...
const workExperience = [
	...
	},
	{
		...
		time: "6 months",
		description:
			"-Designed and fully developed a functional software solution using HTML, JAVA, and MySQL for the customer service department, enhancing the efficiency of departmental operations and enabling faster and more accurate customer service. -Designed and implemented an internal corporate website with WordPress that improved the productivity of 70% of the company's work teams, reducing the time spent searching for information on corporate events. -Identified and corrected 10 code defects in PHP based applications, leading to notable improvements in the work efficiency of approximately 80% of the area staff.",
		certify: "https://www.linkedin.com/in/belsanto/details/experience/",
