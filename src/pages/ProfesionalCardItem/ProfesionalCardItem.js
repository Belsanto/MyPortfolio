...
const workExperience = [
	...
	},
	{
		...
		time: "6 meses",
		description:
			"Estuve a cargo de la creación de un software funcional para el área de servicio al cliente usando JAVA como lenguaje principal y MySQL para la base de datos. También realicé una web interna en WordPress para que los trabajadores de la empresa pudieran acceder a las aplicaciones necesarias para desempeñar sus labores a la vez que permitía la realización de publicaciones de eventos o acontecimientos empresariales. También contribuí con la corrección de defectos de código de algunas aplicaciones de la empresa realizadas en PHP.",
